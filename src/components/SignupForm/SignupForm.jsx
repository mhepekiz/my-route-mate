...
class SignupForm extends Component {
  ...
  isFormInvalid() {
    return !(this.state.username && this.state.name && this.state.phone && this.state.email && this.state.cyclebrand  && this.state.cyclemodel && this.state.rideyears && this.state.detailedinfo && this.state.password === this.state.passwordConf);
  }
